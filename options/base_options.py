...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name_fine', type=str, default='experiment_name', help='name of the experiment.')
        parser.add_argument('--model', type=str, default='pluralistic', help='name of the model type. [pluralistic]')
        parser.add_argument('--model_fine', type=str, default='pluralistic', help='name of the model type. [pluralistic]')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints_train', help='models are save here')
        parser.add_argument('--checkpoints_dir_fine', type=str, default='./checkpoints_train', help='models are save here')
        parser.add_argument('--which_iter', type=str, default='latest', help='which iterations to load')
        parser.add_argument('--which_iter_fine', type=str, default='latest', help='which iterations to load')
        ...
        parser.add_argument('--trainData', type=str, default='/data/dataset/train', help='training and testing dataset')
        parser.add_argument('--mask_file', type=str, default='none', help='load test mask')
        parser.add_argument('--prior_file', type=str, default='none', help='load test mask')
        ...
        parser.add_argument('--resize_or_crop', type=str, default='resize', help='scaling and cropping of images at load time [resize_and_crop|crop|]')
