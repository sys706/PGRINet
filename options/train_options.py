...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        # training epoch
        parser.add_argument('--start_iter', type=int, default=0, help='the starting epoch count')
        parser.add_argument('--iter_count', type=int, default=0, help='the starting epoch count')
        parser.add_argument('--niter', type=int, default=0, help='# of iter with initial learning rate')
